<div class="meta inline-block">
    ...
    ⋅
    {{ trans('site.info.publish at') }} <abbr title="{{ $topic->created_at }}" class="timeago" data-toggle="popover" data-content="{{ $topic->updated_at }}">{{ $topic->created_at->diffForHumans() }}</abbr>
    ⋅
