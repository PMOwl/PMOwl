    ...
    <div class="panel padding-lg rm-padding-top">
        <div class="panel-body">
            ...
            <div class="markdown-body" id="emojify">
                ...
                <p>M ——  machine（机器）</p>
                <p>Owl —— 猫头鹰🦉</p>
                <p>在动画中，人们一般喜欢将猫头鹰拟人化为博学的动物，比如《狮子王》中，机器学习是一个交叉型应用学科，涉及数学，统计学，机械学等等学科，研究机器学习之人需要有多样的知识，同时除了这些研究机器学习的学科，在机器学习应用方面，也需要懂得特定领域的知识，比如在医疗中应用机器学习，需要至少了解医学；比如在图像应用机器学习，至少需要对图像识别有所了解；所以我们将猫头鹰作为我们的吉祥物。</p>
